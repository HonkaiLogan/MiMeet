  ...
  init() {
    ...
    document.getElementById('next-btn').addEventListener('click', () => {
      if (this.state.step === 1) {
        ...
        setStorage('userProfile', { lunchPreference: { time: this.state.time, taste: this.state.tastes, budget: this.state.budget, location: this.state.location, socialMode: this.state.social }, interestTags: this.state.interests });
